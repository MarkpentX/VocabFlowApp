...
function SignInForm() {
    ...
    return (
        <form className="mt-10 flex flex-col gap-4 bg-[rgb(255,255,255)] border-[rgb(226,229,220)] drop-shadow-sm shadow-black rounded-xl p-6 w-full max-w-md mx-auto" onSubmit={(event) => handleSubmit(onSubmit)(event)}>
