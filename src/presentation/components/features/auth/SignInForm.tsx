    ...
    return (
        <form className="mt-10 flex flex-col gap-4 bg-[rgb(255,255,255)] border-[rgb(226,229,220)] drop-shadow-sm shadow-black rounded-xl p-6 w-full max-w-md mx-auto" onSubmit={handleSubmit(onSubmit)}>
            <p className="flex flex-col">
                ...
                <input className="h-10 border-1 border-[rgb(226,229,220)] text-sm text-[rgb(18,33,28)] bg-[rgb(248,249,245)] px-3 py-2 rounded-md" placeholder={t("usernameLabel")} id="username" type="text" {...register("username")}/>
                <span>{formState.errors.username?.message}</span>
            </p>

            <p className="flex flex-col">
                <label htmlFor="password" className="text-[rgb(18,33,28)] font-dMSans text-sm font-bold mb-1">{t("passwordLabel")}</label>
                <input className="h-10 border-1 border-[rgb(226,229,220)] text-sm  text-[rgb(18,33,28)] bg-[rgb(248,249,245)] px-3 py-2 rounded-md" placeholder={t("passwordLabel")} id="password" type="password" {...register("password")}/>
