...
export function GoogleButton() {
    ...
    return (
        <button
            type="submit"
            disabled={pending}
            className="cursor-pointer flex gap-4 items-center px-6 py-2.5 border-gray-300 border-1 rounded-xl hover:bg-gray-100 hover:shadow-sm shadow-gray-300"
        >
            ...
            {pending ? t("loading") : t("googleContinue")}
        </button>
    )
}
