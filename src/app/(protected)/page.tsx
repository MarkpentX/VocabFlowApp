  ...
  return (
      <main>
          <section className="max-w-2xl text-center mx-auto py-[64px] my-24 max-md:my-12 max-md:py-[26px]">
              ...
              <p className="font-dMSans text-[rgb(103,126,119)] text-lg my-[1.5rem] max-w-lg mx-auto animate-[fadeInUp_0.6s_ease-out_forwards] max-md:text-md">Save words, organize them with tags, and practice with interactive quizzes. Your personal vocabulary trainer — simple and effective.</p>
