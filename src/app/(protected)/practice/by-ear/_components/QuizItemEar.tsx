...
import SoundButtonEar from "@/app/(protected)/practice/by-ear/_components/SoundButtonEar";
...
function QuizItemEar({word, onNextQuestion, addCorrect}: QuizItemProps) {
    ...
    return (
        <div className="p-6 bg-[rgb(255,255,255)] border-[rgb(226,229,220)] drop-shadow-sm shadow-black rounded-xl">
            <SoundButtonEar word={word.infinitive}/>
            <p className="text-sm text-[rgb(103,126,119)] mb-4 text-center">Listen and write the word</p>
            <form onSubmit={handleSubmit(onSubmit)}>
                <p className="rounded-md p-2 bg-[rgb(248,249,245)] border-1 border-[rgb(226,229,220)] mb-6">
                    <label htmlFor="answer"></label>
                    <input
                        type="text"
                        placeholder="Write the word you heard:"
                        id="answer"
